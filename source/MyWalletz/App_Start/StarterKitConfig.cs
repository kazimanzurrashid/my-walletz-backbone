...
namespace MyWalletz.Infrastructure
{
    ...
    public class StarterKitConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/formatters")
            ...
            bundles.Add(new ScriptBundle("~/bundles/application")
                ...
                .Include("~/Scripts/application/components/enums.js")
                .Include("~/Scripts/application/components/sortable.js")
                .Include("~/Scripts/application/components/pageable.js")
                .Include("~/Scripts/application/views/activable.js")
