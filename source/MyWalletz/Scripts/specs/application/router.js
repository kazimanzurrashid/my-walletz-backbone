...
describe.skip('Router', function() {
    ...
    describe('navigation', function() {
        ...
        describe('#about', function() {
            ...
            it('activates home view', function() {
                expect(stubbedActivate)
                    .to.have.been.calledWith(router.aboutView, 'about-menu');
            });
        ...
        describe('#home', function() {
            ...
            it('activates home view', function() {
                expect(stubbedActivate)
                    .to.have.been.calledWith(router.homeView, 'home-menu');
            });
    ...
    describe('#activate', function() {
        describe('other view', function() {
            ...
            before(function() {
                ...
                router.activate(router.aboutView, 'about-menu');
            });
            ...
            it('selects other view menu', function() {
                expect(spiedSelectMenu).to.have.been.calledWith('about-menu');
            });
        ...
        describe('same view', function() {
            ...
            before(function() {
                ...
                spiedHomeViewDeactivate = sinon.spy(router.homeView, 'deactivate');
                router.currentView = router.homeView;
                router.activate(router.homeView, 'home-menu');
            });
